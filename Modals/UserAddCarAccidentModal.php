...
<div class="modal fade " tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" id="UserAddCarAccidentModal">
...
<table class="carDataTable ">
              ...
              <tr>
                     <td class="text-left ">Select the Car -     إختر المركبة</td>
                      <td>
                         <select id="CarList" class="form-control" onchange="getSelectedCarID()">
                             <!---Car List under current user first list car under him---->
                             <?php
                             $sql = "select `car_id`, `driver_id` from `car_users` where `driver_id` = ".$_GET["id"].";";
                             $result = $conn->query($sql);
                             while($row =$result->fetch_array(MYSQLI_ASSOC))
                             {
                                 echo("<option>".$row["car_id"]."</option>");
                             }
                             ?>
                  ...
                  <script>
                      ...
                      {
                         let CarId =   document.getElementById("CarList").value;
                  ...
                  <tr>
                     <td class="text-left ">Car ID -   رقم  المركبة</td>
                      <td><input type="text" name="CarID" id="CarID" class="form-control" value="" readonly/></td>
                  </tr>
