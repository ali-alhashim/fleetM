    ...
    <br/>
       ...
       <hr>
         ...
         <div class="row m-3">
             ...
             <div class="col-6 text-left">
            <button class="btn btn-success" data-toggle="modal" data-target="#AddUserModal"><i class="fa-solid fa-plus"></i><br/>Add <br/> </button>
          ...
          <table class="  table-hover carDataTable" id="usersListTable">
              <thead>
                  <tr>
                      ...
                      <td>ID</td>
                      <td class='hidecolumns'>arabic name <br/>  </td>
                      <td>Name <br/> </td>
                      <td class='hidecolumns'>Email <br/>  </td>
                      <td> Company <br/>   </td>
                      <td> Department <br/>  </td>
                      <td class='hidecolumns'>Badge Number </br/>  </td>
                     
                      <td class='hidecolumns'>Permission <br/>  </td>
              ...
              <?php
                 ...
                 $sql = "select `id`,  `arabic_name`, `full_name`,  `email`, `company`, `department`, `badge_number`,  `permission_group` from `users` $SQLSearch  $limit ; ";
                 ...
                 while($row = $result->fetch_array(MYSQLI_ASSOC))
                 {
                     ...
                     echo('<td ><a href="profile.php?id='.$row["id"].'" class="btn btn-info w-100">'.$row["id"].'</a></td>');
