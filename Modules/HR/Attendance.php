    ...
    <br/>
       ...
       <hr>
         ...
         <div class="row m-3">
            ...
            Show 
            <form action="Suppliers.php" method="GET" id="ShowRecords">
         ...
         <div class="col-6 text-left">
         <button class="btn btn-success" data-toggle="modal" data-target="#AddNewITSupplierModal"><i class="fa-solid fa-plus"></i><br/>Add <br/> </button>
         </div>

          <!--?php require("Modals/AddNewITSupplierModal.php") ?-->
...
<hr>
          ...
          <table class="  table-hover carDataTable">
              <thead>
                  <tr>
                      ...
                      <td>ID <br/> الرقم المعرف</td>
                      <td>Serial Number <br/>  الرقم التسلسلي</td>
                      <td>Device Name <br/> أسم  الجهاز</td>
                      <td> Area <br/> المنطقة</td>
                      <td> Device IP <br/>  عنوان الجهاز على الشبكة</td>
                      <td> User Quantity<br/> مجموع المسجلين</td>
                      <td> last sync <br/>  تاريخ آخر مزامنة</td>
              ...
              <?php
                 ...
                 $sql = "select `id`,  `creation_date`,   `supplier_name`, `website`, `contact_name`, `contact_email`, `contact_mobile`, `address`, `due_payment` from `it_supplier` $SQLSearch  order by `creation_date` DESC $limit ; ";
                 ...
                 while($row = $result->fetch_array(MYSQLI_ASSOC))
                 {
                     ...
                     echo('<td ><a href="SupplierDetails.php?id='.$row["id"].'" class="btn btn-info w-100">'.$row["id"].'</a></td>');
         ...
         <div class="row m-3">
             <div class="col-6 text-left">
                 <?php
                 $sql = "SELECT count(id) FROM `it_supplier` $SQLSearch;";
                 $result = $conn->query($sql);
