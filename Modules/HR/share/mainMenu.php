...
<header class="text-center header-full">
        <nav class="navbar navbar-expand-sm navbar-toggleable-sm navbar-light bg-white border-bottom box-shadow mb-3">
                ...
                <div class="navbar-collapse collapse d-sm-inline-flex justify-content-center">
                    ...
                    <ul class="navbar-nav flex-grow-1 justify-content-center w-100">
                        ...
                        <li class="nav-item btn-akhOrange  w-100" id="caraccidenttap">
                            <a class="nav-link text-dark" href="Payroll.php">Payroll <br/>كشف الرواتب   </a>
                        </li>

                        <li class="nav-item btn-akhOrange  w-100" id="caraccidenttap">
                            <a class="nav-link text-dark" href="Attendance.php"> Attendance <br/>الحضور و الإنصراف</a>
                        </li>

                        <li class="nav-item btn-akhOrange  w-100" id="reporttap">
                            <a class="nav-link text-dark" href="Departments.php">Departments <br/>   الأقسام  </a>
                        ...
                        <li class="nav-item btn-akhOrange  w-100" id="userstap">
                            ...
                            <li class="nav-item btn-akhOrange  w-100" id="userstap">
                            <a class="nav-link text-dark h-100" href="Candidats.php">Candidats <br/> المرشحون  </a>
                        </li>
            ...
            <ul class="dropdown-menu p-2 dropMenuX">
                ...
                <li><hr></li>
                <li><a class="btn btn-secondary w-100 active" href="../HR/index.php"><img src="../../gallery/icons/icons8_organization_chart_people_32px.png"/> HR.</a></li>
                <li><hr></li>
