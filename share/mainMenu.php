...
<header class="text-center header-full">
        <nav class="navbar navbar-expand-sm navbar-toggleable-sm navbar-light bg-white border-bottom box-shadow mb-3">
                ...
                <div class="navbar-collapse collapse d-sm-inline-flex justify-content-center">
                    ...
                    <ul class="navbar-nav flex-grow-1 justify-content-center w-100">
                        ...
                        <li class="nav-item btn-akhOrange w-100 " id="dashboardtap">
                            <a class="nav-link text-dark" href="dashboard.php">Dashboard <br/> لوحة المعلومات</a>
                        </li>


                        <li class="nav-item btn-akhOrange  w-100" id="cardatatap">
                            <a class="nav-link text-dark" href="carsData.php?pageNo=0">Car List <br/>قائمة المركبات</a>
                        </li>


                        <li class="nav-item btn-akhOrange  w-100" id="caraccidenttap">
                            <a class="nav-link text-dark" href="carAccident.php">Car Accident <br/> حوادث المركبات</a>
                        </li>

                        <li class="nav-item btn-akhOrange  w-100" id="reporttap">
                            <a class="nav-link text-dark" href="Report.php">Report <br/> التقارير</a>
                        </li>

                        <li class="nav-item btn-akhOrange  w-100" id="userstap">
                            <a class="nav-link text-dark" href="UsersList.php?pageNo=0">Users <br/> المستخدمين</a>
                        </li>

                        <li class="nav-item btn-akhOrange  w-100" id="userstap">
                            <a class="nav-link text-dark" href="RequestsList.php?pageNo=0">Requests <br/> الطلبات</a>
                        </li>

                        <li class="nav-item btn-akhOrange  w-100" id="settingstap">
                            <a class="nav-link text-dark" href="Settings.php">Settings <br/>التحكم</a>
                        </li>
            ...
            <ul class="dropdown-menu p-2 dropMenuX">
                <li><hr></li>
                <li><a class="btn btn-secondary w-100" href="UserDetails.php?id=<?=$_SESSION["id"]?>"><i class="fa-solid fa-id-card"></i> Profile</a></li>
                <li><hr></li>
                <li><a class="btn btn-secondary w-100 active" href="#"><img src="gallery/icons/icons8_oncoming_automobile_32px.png"/> Fleet.</a></li>
                <li><hr></li>
                <li><a class="btn btn-secondary w-100" href="Modules/IT/index.php"><img src="gallery/icons/icons8_laptop_32px.png"/> IT.</a></li>
                <li><hr></li>
                <li><a class="btn btn-secondary w-100" href="Modules/Government/index.php"><img src="gallery/icons/icons8_saudi_arabia_32px.png"/> GRO.</a></li>
                <li><hr></li>
                <li><a class="btn btn-secondary w-100" href="Modules/HR/index.php"><img src="gallery/icons/icons8_organization_chart_people_32px.png"/> HR.</a></li>
                <li><hr></li>
                <li><a class="btn btn-secondary w-100" href="Modules/Workshop/index.php"><img src="gallery/icons/icons8_mechanic_32px.png"/> Workshop.</a></li>
                <li><hr></li>
